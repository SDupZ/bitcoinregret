    ...
    <Styled.Layout>
      ...
      <Styled.Content>
        <Styled.PolicyContent>
          ...
          <p>You can find additional information on how to install the browser add-on referenced above at the following link: https://tools.google.com/dlpage/gaoptout?hl=en.</p>

          <p>For the cases in which personal data is transferred to the US, Google has self-certified pursuant to the EU-US Privacy Shield (https://www.privacyshield.gov/EU-US-Framework).</p>

          <h2>Google Tag Manager (GTM)</h2>
          <p>Google Tag Manager (GTM”) is a tag management system to manage JavaScript and HTML tags used for tracking and analytics on websites. Tags are small code elements that, among other things, are used to measure traffic and visitor behaviour: to understand the effect of online advertising and social channels; to set up remarketing and orientation towards target groups; and to test and optimize websites. GTM makes it easier for us to integrate and manage our tags. We use GTM on our website to include the following tracking tools (as in described in detail this Section 12):</p>
          <ul>
            <li>Google Analytics</li>
          </ul>

          <p>If you have performed deactivation, GTM takes this deactivation into account. For more information about GTM’s privacy practices can be found at https://policies.google.com/privacy?hl=en and terms of use at https://www.google.com/analytics/tag-manager/use-policy/.</p>
